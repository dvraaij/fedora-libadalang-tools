# Option to run the testsuite after the installation.
%define with_check 1
...
# Additional flags to dynamically link the executables with the GNAT runtime
# and make the executables (tools) position independent.
%global GPRbuild_optflags_pie -cargs -fPIC -largs -pie -bargs -shared -gargs
